...
<body>
    ...
    <div class="container">
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <!-- PHP code for searching patients -->
                <tr>
                   <td colspan="4">
                       <center>
    ...
    <div id="addPatientPopup" class="overlay">
        <div class="popup">
            <center>
                ...
                <div style="display: flex;justify-content: center;">
                    <form action="" method="post" class="add-patient-form">
                        <input type="text" name="pname" placeholder="Patient Name" required><br><br>
                        <input type="text" name="ptel" placeholder="Telephone" required><br><br>
                        <input type="email" name="pemail" placeholder="Email" required><br><br>
                        <input type="date" name="pdob" required><br><br>
    ...
    <?php 
    // PHP code for adding a new patient
    if($_POST && isset($_POST['pname'], $_POST['ptel'], $_POST['pemail'], $_POST['pdob'])) {
        $pname = $_POST['pname'];
        $ptel = $_POST['ptel'];
        $pemail = $_POST['pemail'];
        $pdob = $_POST['pdob'];
        ...
        $insertQuery = "INSERT INTO patient (pname, ptel, pemail, pdob) VALUES ('$pname', '$ptel', '$pemail', '$pdob')";
        if($database->query($insertQuery) === TRUE) {
            // Redirect to the patient page after adding the patient
