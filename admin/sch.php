            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <form action="add-session.php" method="POST" class="add-new-form">
                                    <label for="title" class="form-label">patient name : </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="title" class="input-text" placeholder="Name of this patient" required><br>
                                </td>
                            </tr>
                            <tr>
                        ...
                        echo     '       </select><br><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="nop" class="form-label">Appointment Number : </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
